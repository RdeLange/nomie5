export default {
  ...
  translation: {
    settings: {
      ...
      "feature-addons-tracking": "Addons Tracking",
      "feature-circlemenu": "Enable Circle Menu (beta)",
      "feature-journals-tracking": "Journals Tracking",
      "feature-periods-tracking": "Periods Tracking",
      "feature-people-description": "Keep track of those you interact with the most",
      "feature-journals-description": "Keep track of your Journals",
      "feature-addons-description": "Keep track of your Addons",
      "feature-circlemenu-description": "Enable experimental circle menu",
      "feature-periods-description": "Keep track of specific periods during your life",
    ...
    dashboard: {
      ...
      "show-periods-toggle": "Toggle Show Periods",
      "show-periods-description": "Toggle if you want to show your defined periods in your charts",
    ...
    journals: {
      ...
      "empty-message": "Track & monitor which guided journals you regularly use",
      "add-a-journal": "Add a Guided Journal Template...",
      "log-entry": "Log-entry",
    },
    addons: {
      "addon-name": "Addon Name",
      "empty-message": "All installed addons will be listed here",
      "install":"Install your first Addon!",
    },
    periods: {
      "period-name": "Period Name",
      "empty-message": "Track & monitor specific periods in your life",
